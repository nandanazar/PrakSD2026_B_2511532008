...
public class InsertionSortGUI_2511532008 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public InsertionSortGUI_2511532008() {
	...
	private void performStep_2008() {
	    if (i_2008 < array_2008.length && sorting_2008) {
	        int key_2008 = array_2008[i_2008];
	        int j_2008 = i_2008 - 1;

	        StringBuilder stepLog_2008 = new StringBuilder();
	        stepLog_2008.append("Langkah ").append(stepCount_2008)
	                .append(": Memasukkan ").append(key_2008).append("\n");

	        while (j_2008 >= 0 && array_2008[j_2008] > key_2008) {
	            array_2008[j_2008 + 1] = array_2008[j_2008];
	            j_2008--;
	        }
	        array_2008[j_2008 + 1] = key_2008;
	...
	public static void main(String[] args) {
	    SwingUtilities.invokeLater(() -> {
	        InsertionSortGUI_2511532008 gui_2008 = new InsertionSortGUI_2511532008();
